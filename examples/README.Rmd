...
> code from the pull request via roxygen2. Only use it on repositories where you
> trust all contributors. For repositories that accept untrusted contributions,
> use [`pr-commands`](#commands-workflow) instead, which requires an explicit
> comment from a MEMBER or OWNER.
